...
function (_React$Component) {
  ...
  _createClass(Div100vh, [{
    ...
    value: function setNodeHeightToWindowInnerHeight() {
      return this.myRef ? this.myRef.style.height = window.innerHeight + 'px' : null;
